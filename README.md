...
<h2 align="center">支持模型列表</h2>
  ...
  |   排序   |                     [GateNet](models/rank/gateDnn/)                     |    ✓    |    ✓    |     ✓     |     x     | >=2.1.0 | [SIGIR 2020][GateNet: Gating-Enhanced Deep Network for Click-Through Rate Prediction](https://arxiv.org/pdf/2007.03519.pdf)                                                              |
