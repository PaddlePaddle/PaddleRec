...
<h2 align="center">Support model list</h2>
  ...
  |        Recall         |                 [Gru4Rec](https://github.com/PaddlePaddle/PaddleRec/tree/release/1.8.5/models/recall/gru4rec/)([doc](https://paddlerec.readthedocs.io/en/latest/paddlerec/gru4rec.html))                |   ✓   |    ✓    |        ✓         |     ✓     | [1.8.5](https://github.com/PaddlePaddle/PaddleRec/tree/release/1.8.5) | [2015][Session-based Recommendations with Recurrent Neural Networks](https://arxiv.org/abs/1511.06939)                                                                                                      |
