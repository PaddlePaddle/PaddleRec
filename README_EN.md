...
<h2 align="center">Support Model List</h2>
  ...
  |         Match         |                   [MultiView-Simnet](models/match/multiview-simnet/)<br>([doc](https://paddlerec.readthedocs.io/en/latest/models/match/multiview-simnet.html))                   |  [Python CPU/GPU](https://aistudio.baidu.com/aistudio/projectdetail/3238206)  |         ✓         |     x     |      >=2.1.0     |                        [SIGIR 2021][A Multi-View Deep Learning Approach for Cross Domain User Modeling in Recommendation Systems](https://www.microsoft.com/en-us/research/wp-content/uploads/2016/02/frp1159-songA.pdf)                         |
