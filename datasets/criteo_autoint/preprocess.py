...
parser.add_argument('--source_data', type=str, required=True, default='./criteo.txt', help='source path')
parser.add_argument('--output_path', type=str, required=True, default='./Criteo', help='output path')
