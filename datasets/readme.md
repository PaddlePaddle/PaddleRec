...
## 数据集简介
 ...
 |[movielens](https://paddlerec.bj.bcebos.com/ncf/Data.zip)|该数据集共包含了6000多位用户对近3700个电影的100多万条评分数据，评分为1～5的整数，其中每个电影的评分数据至少有20条|[《Neural Collaborative Filtering 》](https://arxiv.org/pdf/1708.05031.pdf)|
