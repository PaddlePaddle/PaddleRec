# FAT_DeepFFM (FAT-DeepFFM: Field Attentive Deep Field-aware Factorization Machine)

代码请参考：[FAT_DeepFFM](https://github.com/PaddlePaddle/PaddleRec/tree/master/models/rank/fat_deepffm)  
