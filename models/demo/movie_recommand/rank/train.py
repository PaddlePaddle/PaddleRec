...
def main(args):
    ...
    if model_init_path is not None:
        load_model(model_init_path, rank_model)

    # to do : add optimizer function
    optimizer = paddle.optimizer.Adam(parameters=rank_model.parameters())
    ...
    for epoch_id in range(last_epoch_id + 1, epochs):
        ...
        save_model(
            rank_model, optimizer, model_save_path, epoch_id, prefix='rec')
