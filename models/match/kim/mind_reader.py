    ...
    def __init__(self, file_list, config, mode=None):
        ...
        if mode == 'train':
            ...
            self.dataset = TrainDataset(news_title, news_entity_index,
                                        ...
                                        train_sess, train_label, batch_size)
            ...
            self.dataset = TestDataset(test_docids, test_userids, news_title,
                                       news_entity_index, one_hop_entity,
                                       entity_embedding, test_user['click'],
                                       batch_size)
