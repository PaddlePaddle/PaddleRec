...
def main(args):
    ...
    train_dataloader = paddle.io.DataLoader(
        train_dataloader.dataset, batch_size=1, shuffle=True)
    word_emb = train_dataloader.dataset.title_word_embedding_matrix
    dy_model.model.context_encoder.title_word_embedding.weight.set_value(
        word_emb)
            ...
            if batch_id % print_interval == 0:
                ...
                logger.info(
                    "epoch: {}, batch_id: {}, lr: {}, ".format(
                        epoch_id, batch_id, optimizer.get_lr(
