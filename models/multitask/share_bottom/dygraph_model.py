...
class DygraphModel():
    ...
    def create_model(self, config):
        ...
        task_num = config.get('hyper_parameters.task_num', None)
        bottom_size = config.get('hyper_parameters.bottom_size', None)
        tower_size = config.get('hyper_parameters.tower_size', None)

        ShareBottom = net.ShareBottomLayer(feature_size, task_num, bottom_size,
                                           tower_size)
