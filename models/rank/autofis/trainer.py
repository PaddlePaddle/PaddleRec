...
def main(args):
    ...
    optimizer1, optimizer2 = dy_model_class.create_optimizer(dy_model, config)
    ...
    if use_fleet and stage == 1:
        ...
        optimizer = fleet.distributed_optimizer(optimizer1)
    ...
    step_num = 0
    gamma = config.get("hyper_parameters.optimizer.gamma", 0.7)
    decay_steps = len(train_dataloader) // 5
