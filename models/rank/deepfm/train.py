...
def create_model(config):
    ...
    deepfm_model = net.DeepFMLayer(sparse_feature_number, sparse_feature_dim,
...
def main(args):
    ...
    if model_init_path is not None:
        load_model(model_init_path, deepfm_model)

    # to do : add optimizer function
    optimizer = paddle.optimizer.Adam(parameters=deepfm_model.parameters())
    ...
    for epoch_id in range(last_epoch_id + 1, epochs):
        ...
        for batch_id, batch in enumerate(train_dataloader()):
            ...
            pred = deepfm_model(sparse_tensor, dense_tensor)
        ...
        save_model(
            deepfm_model, optimizer, model_save_path, epoch_id, prefix='rec')
