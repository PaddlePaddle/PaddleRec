...
class DygraphModel():
    ...
    def create_model(self, config):
        ...
        din_model = net.DINLayer(item_emb_size, cat_emb_size,act,
                                 is_sparse, use_DataLoader,
    ...
    def train_forward(self, dy_model, metrics_list, batch_data, config):
        hist_item_seq, hist_cat_seq, target_item, target_cat, label, mask, target_item_seq, target_cat_seq = self.create_feeds(batch_data,
                                                                config)

        raw = dy_model(hist_item_seq, hist_cat_seq, target_item, target_cat, label, mask, target_item_seq, target_cat_seq)
