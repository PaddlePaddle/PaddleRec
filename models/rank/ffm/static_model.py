...
class StaticModel():
    ...
    def net(self, input, is_infer=False):
        ...
        sparse_number = self.sparse_inputs_slots - 1 + self.dense_input_dim  # label is also sparse_slots

        ffm_model = FFMLayer(self.sparse_feature_number,
