...
class DygraphModel():
    ...
    def create_model(self, config):
        ...
        layer_sizes_cin = config.get("hyper_parameters.layer_sizes_cin")
        ...
        xdeepfm_model = net.xDeepFMLayer(sparse_feature_number,
                                       sparse_feature_dim, dense_feature_dim,
                                       sparse_input_slot - 1, layer_sizes_cin,
                                       layer_sizes_dnn)

        return xdeepfm_model
