...
class Model(ModelBase):
    ...
    def net(self, inputs, is_infer=False):
        ...
        def embedding_layer(input,
            ...
            if squeeze:
                return paddle.squeeze(x=emb, axis=[1])
            else:
                return emb
        ...
        if self.with_shuffle_batch:
            ...
            neg_emb_b = paddle.concat(x=neg_emb_b_list, axis=0)
            neg_emb_b_vec = paddle.fluid.layers.nn.reshape(
        ...
        neg_matmul_re = paddle.fluid.layers.nn.reshape(
    ...
    def infer_net(self, inputs):
        ...
        label = paddle.fluid.layers.expand(
            paddle.unsqueeze(
                a=inputs[3], axis=[1]), expand_times=[1, 1])
