...
class Model(ModelBase):
    ...
    def input_data(self, is_infer=False):
        item_len = envs.get_global_env("hyper_parameters.item_len", None, self._namespace)
    ...
    def fluid_sequence_get_pos(self, lodtensor):
        ...
        ones_padded = self.fluid_sequence_pad(ones, 0)               # (batch, max_seq_len, 1)
    ...
    def net(self, inputs, is_infer=False):
        ...
        user_vocab = envs.get_global_env("hyper_parameters.user_vocab", None, self._namespace)
        item_vocab = envs.get_global_env("hyper_parameters.item_vocab", None, self._namespace)
