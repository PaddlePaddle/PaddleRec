...
"""
import paddle
from net import TDMSampleLayer
...
class StaticModel():
    ...
    def net(self, input, is_infer=False):
        ...
        tdm_sample_layer = TDMSampleLayer(self.config)
        node_embedding, labels, mask = tdm_sample_layer(item_label)
        # predict, sample_label = learning_to_index_model(input_emb, item_label)
