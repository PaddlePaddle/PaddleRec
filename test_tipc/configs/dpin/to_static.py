    ...
    dy_model = paddle.jit.to_static(
        ...
        input_spec=[
            paddle.static.InputSpec(
                shape=[None, K, L], dtype='int64',
                name='hist_item'), paddle.static.InputSpec(
                    shape=[None, K, L], dtype='int64',
                    name='hist_cat'), paddle.static.InputSpec(
                        shape=[None], dtype='int64',
                        name='target_item'), paddle.static.InputSpec(
                            shape=[None], dtype='int64', name='target_cat'),
            paddle.static.InputSpec(
                shape=[None, K], dtype='int64', name='position')
        ])
